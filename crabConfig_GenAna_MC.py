...
outputDataset_ = {
        'ATauTau':'GEN_SIM_ATo2Tau_m3p6To18_pt30To300_v2',
...
config.General.requestName = '%s_GenAna_moreFiles'%Process
...
config.JobType.psetName = 'GenAnalyzer/python/ConfFile_cfg.py'
